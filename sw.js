const CACHE='abacus-ai-v2';
const ASSETS=['./','./index.html','./styles.css','./challengeApp.js','./abacusEngine.js','./manifest.json','./assets/mascot/babi.svg','./icons/icon-192.png','./icons/icon-512.png'];
