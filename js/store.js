...
function load() {
  ...
  return { ...base, ...data, settings: { ...base.settings, ...data.settings }, stats: { ...base.stats, ...data.stats, byRule: { ...base.stats.byRule, ...(data.stats?.byRule || {}) } }, games: { ...base.games, ...data.games }, stickersSeen: Array.isArray(data.stickersSeen) ? data.stickersSeen : [] };
}
