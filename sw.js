const CACHE='abacus-ai-phase5-shell-v17';
const ASSETS=[
  ...
  './playModes.js','./babiVoice.js','./audioFx.js','./kidUi.js','./manifest.json','./assets/mascot/babi.svg','./icons/icon-192.png','./icons/icon-512.png'
];
