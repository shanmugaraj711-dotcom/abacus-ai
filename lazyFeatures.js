...
(function(){
  ...
  // Dependency-safe order. This runs only after the first screen is already painted.
  const polish=[
    ...
    './celebration.js?v=20260914-applause5','./feedbackUX.js?v=20260914-audit2','./phase5CoreUX.js?v=20260915-phase5ux1','./phase5FlowGuard.js?v=20260915-flowguard1'
  ];
