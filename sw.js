const CACHE='abacus-ai-v3';
const ASSETS=['./','./index.html','./styles.css','./tutor.css','./challengeApp.js','./abacusEngine.js','./manifest.json','./assets/mascot/babi.svg','./icons/icon-192.png','./icons/icon-512.png'];
