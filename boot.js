...
(function(){
  ...
  async function loadEnhancements(){
    try{await import('./babiVoice.js');await import('./audioFx.js');await import('./kidUi.js');await import('./sessionSummary.js');await import('./homeBabi.js');await import('./learnPracticeUX.js');await import('./v1ProgressUX.js');await import('./parentProgressUX.js')}catch(err){console.error('Optional layer failed',err)}
  }
  ...
  window.addEventListener('load',()=>{if('serviceWorker' in navigator)navigator.serviceWorker.register('./sw.js?v=20260916-v39').catch(()=>{})});
})();
